...
//                }
                ...
                property bool wasNeg: false
                property int counter: 0

//                onContentYChanged: {


////                    if (contentY < -headerItem.height) {
////                        contentY = -headerItem.height
////                    }

//                    console.log("y: " + contentY)

//                    if (contentY == 0 && wasNeg) {
//                        console.log("trigger")
//                        wasNeg = false;

//                        behavy.enabled = true
//                        behavRot.enabled = true

//                        thingie.y = -thingie.height
//                        thingie.rot = 0;
//                        counter = 0
//                    } else if (contentY < 0) {

//                        behavy.enabled = false
//                        behavRot.enabled = false

////                        counter++
////                        thingie.y = 100* (1-Math.exp(-counter/30)) - thingie.height

//                        thingie.y = -contentY
//                        thingie.rot = -thingie.y
